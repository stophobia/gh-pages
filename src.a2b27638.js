...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/jquery.terminal/css/jquery.terminal.css":[function(require,module,exports) {
...
},{"base64-js":"node_modules/base64-js/index.js","ieee754":"node_modules/ieee754/index.js","isarray":"node_modules/isarray/index.js","buffer":"node_modules/buffer/index.js"}],"node_modules/defaults/node_modules/clone/clone.js":[function(require,module,exports) {
...
},{"clone":"node_modules/defaults/node_modules/clone/clone.js"}],"node_modules/wcwidth/combining.js":[function(require,module,exports) {
module.exports = [
...
},{"jquery":"node_modules/jquery/dist/jquery.js","wcwidth":"node_modules/wcwidth/index.js","process":"node_modules/process/browser.js"}],"src/projects.js":[function(require,module,exports) {
"use strict";
...
var $ = window.$ = window.jQuery = terminal(void 0, jquery);
var Projects = /*#__PURE__*/function () {
  ...
  _createClass(Projects, [{
    key: "get",
    value: function get() {
      if (_typeof(window._jabernardo_term_projects) == "object") {
        return window._jabernardo_term_projects;
      }
      var resp = null;
      $.ajax({
        url: "https://api.github.com/users/stophobia/repos",
        method: "get",
        async: false,
...
},{"jquery":"node_modules/jquery/dist/jquery.js","jquery.terminal":"node_modules/jquery.terminal/js/jquery.terminal.js"}],"src/cv.js":[function(require,module,exports) {
"use strict";
...
var CV = /*#__PURE__*/function () {
  function CV() {
    ...
    this.HomeMessage = "                                       \n[[;#00ff00;] @@@@  [[;#00dd00;]Stophobia\n[[;#00ff00;]@@   @\n[[;#00ff00;]  @@   [[;#00dd00;]Portfolio\n[[;#00ff00;]@   @@  \n[[;#00ff00;] @@@@  [[;#00dd00;]Resume CV\n\n[[;#00dd00;]Hi there! I'm Hyunmyung Park.\nJust type \"help\" for the list of commands.\n  ";
    this.Commands = {
      education: "\n## View my educational background ##\n\n[[;white;]Bachelor of literature in Japanese Education\n+ 1996-2003\n&nbsp;&nbsp;- Konkuk university\n&nbsp;&nbsp;- Seoul, Korea\n      ",
      work: "\n## Know where I work and what I did ##\n\n[[;white;]Investment App Services, in a Stock Securities Company.\n+ Project Manager(2020-Present)\n\n[[;white;]Travel Services, in a Travel Agency.\n+ Lead Developer(2018-2020)\n&nbsp;&nbsp;&nbsp;&nbsp;= Growth hack design and implementation of travel-related services such as airline tickets.\n&nbsp;&nbsp;&nbsp;&nbsp;= UI/UX design and front-end development for tour reservation services.\n\n[[;white;]Online Education Services and Private Tutor Services, in a Education Company.\n+ Lead Developer(2017-2018)\n&nbsp;&nbsp;&nbsp;&nbsp;= Development of tutoring site and online education site.\n\n[[;white;]Online Game Services, in some Game Companies.\n+ Lead Developer, Lead UI/UX Designer(2008-2017)\n&nbsp;&nbsp;&nbsp;&nbsp;= Mobile game UI/UX design, front-end development.\n      ",
      //       awards: `
      // ## Some awards ##
      // 🏆 [[;green;] Mr. Programmer
      ...
      contact: "\n## Know where to contact me ##\n[[;white;]E-mail me at [[;#ccccff;]stophobia@gmail.com[[;white;]. Have a good day! \n",
      projects: function projects() {
        var use_descriptions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
        if (use_descriptions) return "## My Personal projects ##";
        var screen = "";
        var proj = new _projects.default();
        proj.get().forEach(function (data) {
          screen += "\n+ [[;white;]".concat(data.name, "[[;white;] ([[;#ccccff;]").concat(data.html_url, "[[;white;])\n&nbsp;&nbsp;- ").concat(data.description, "\n");
        });
        return screen;
      }
    };
  ...
  _createClass(CV, [{
    key: "getHomeScreen",
    value: function getHomeScreen() {
      return this.HomeMessage;
    }
  }, {
    key: "getInfo",
    value: function getInfo(keyword) {
    ...
    value: function getHelp() {
      ...
      Object.keys(this.Commands).forEach(function (cmd) {
        var preview = "";
        var tokens = typeof _this.Commands[cmd] === "function" ? _this.Commands[cmd](true).match(/##(.*)##/g) : _this.Commands[cmd].match(/##(.*)##/g);

        // console.log(typeof tokens);
        if (tokens != null) {
          preview = tokens.join("").replace(/#/g, "").trim();
        }
        help += "\t[[;yellow;]".concat(cmd.padEnd(15), "[[;white;]").concat(preview, "\n");
      });
      return help;
    }
  }]);
...
var _default = CV;
exports.default = _default;
},{"./projects.js":"src/projects.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var $ = window.$ = window.jQuery = terminal(void 0, jquery);
$(function ($) {
  var cv = new _cv.default();
  var term = $("#app").terminal(function (command, term) {
    term.pause();
    var msg = "";
    switch (command.toLowerCase()) {
      ...
      default:
        ...
        if (results !== null) {
          ...
          msg = "[[;red;]Command \"".concat(command, "\" not found.");
        }
        break;
    }
    term.resume();
...
},{"./style.css":"src/style.css","jquery.terminal/css/jquery.terminal.css":"node_modules/jquery.terminal/css/jquery.terminal.css","./cv.js":"src/cv.js","jquery":"node_modules/jquery/dist/jquery.js","jquery.terminal":"node_modules/jquery.terminal/js/jquery.terminal.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
